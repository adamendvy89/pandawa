...
class list_download_dinas extends MX_Controller {
   ...
   {  
      ...
      $d['dt_index_download'] = $this->app_global_model->generate_index_download_dinas($id_param,$this->config->item("limit_item_medium"),$uri);
      ...
      $this->load->view($_SESSION['site_theme'].'/bidang/list_download_dinas/bg_home');

	...
	<div class="main-container">
		<div class="container-fluid">
			<section>
				...
				<label for="id_bidang"Kategori</label>
				<div class="cleaner_h5"></div>
				<select name="id_bidang">
					<?php foreach($bidang->result_array() as $dt_bg)
					{
						if($id_bidang==$dt_bg["id_super_bidang"])
						{
					?>
						<option value="<?php echo $dt_bg['id_super_bidang']; ?>" selected="selected"><?php echo $dt_bg['bidang']; ?></option>
					<?php 
						}
						else
						{
					?>
						<option value="<?php echo $dt_bg['id_super_bidang']; ?>"><?php echo $dt_bg['bidang']; ?></option>
					<?php } } ?>
				</select>
				<div class="cleaner_h10"></div>

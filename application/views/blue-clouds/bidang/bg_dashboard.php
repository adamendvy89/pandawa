...
<div id="box-title">BIDANG <?php echo $bidang; ?></div>
	...
	<div id="dashboard-icon">
		<a href="<?php echo base_url(); ?>web/produk_dinas/get/<?php echo $id_super_bidang; ?>">
		<img src="<?php echo base_url(); ?>asset/theme/<?php echo $_SESSION['site_theme']; ?>/images/produk-icon.png" border="0" />
		</a>
		<div class="cleaner_h0"></div>
		produk DINAS
	</div>

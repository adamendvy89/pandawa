...
<div id="box-title">DASHBOARD</div>
	...
	<div id="dashboard-icon-small">
		<a href="<?php echo base_url(); ?>admin_dinas/produk_dinas">
		<img src="<?php echo base_url(); ?>asset/theme/<?php echo $_SESSION['site_theme']; ?>/images/produk-icon.png"  width="70" border="0"/>
		</a>
		<div class="cleaner_h0"></div>
		produk DINAS
	</div>
